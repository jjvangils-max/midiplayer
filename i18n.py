...
_STRINGS = {
    "en": {
        ...
        "insufficient_title": "Not enough credit!",
        "insufficient_amount": "Please add €{amount} more",
        "waiting_organ": "Waiting for the organ to start up",
        "warmup_secs": "{s}s",
    ...
    "fr": {
        ...
        "insufficient_amount": "Veuillez ajouter {amount} € de plus",
        "waiting_organ": "Attente du démarrage de l'orgue",
        "warmup_secs": "{s}s",
